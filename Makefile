.PHONY: help install dev test lint format clean run sync package-prep deb rpm flatpak arch appimage clean-appimage update-i18n compile-i18n i18n pyinstaller
...
pyinstaller:
	uv run pyinstaller --clean sshive.spec --noconfirm
